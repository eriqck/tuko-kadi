        ...
        >
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="cursor-pointer rounded-[1.8rem] border border-white/20 bg-white/[0.03] p-6 shadow-sm shadow-black/10 transition transform hover:-translate-y-1 hover:shadow-xl hover:border-red-500/30"
              >
          ...
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="grid gap-4">
              {centers.map((center) => (
                <div
                  key={center.name}
                  className="rounded-[1.8rem] border border-white/20 bg-white/[0.03] p-6 shadow-sm shadow-black/10 transition-shadow hover:shadow-lg"
                >
